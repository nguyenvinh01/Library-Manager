...
public class ReturnBook extends JFrame implements ActionListener{
    ...
    public void delete() {
        try {
            ...
            if (i > 0)
                JOptionPane.showConfirmDialog(null, "Đã trả sách!!");
            else
    ...
    public ReturnBook() {
        ...
        JLabel lblBranch = new JLabel("Khoa");
        ...
        lblDateOfIssue.setBounds(52, 135, 105, 29);
        ...
        lblDateOfReturn.setBounds(52, 175, 118, 29);
        ...
        textField_6.setBounds(146, 145, 150, 20);
        contentPane.add(textField_6);

        dateChooser = new JDateChooser();
        dateChooser.setBorder(new LineBorder(new Color(0, 0, 0), 0, true));
        dateChooser.setBounds(140, 180, 165, 26);
