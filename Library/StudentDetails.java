...
public class StudentDetails extends JFrame implements ActionListener{
    ...
    public StudentDetails() {
        ...
        JButton b1 = new JButton("Tìm");
        b1.addActionListener(this);
        b1.setBorder(new LineBorder(new Color(255, 20, 147), 2, true));
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Library/icons/eight.png"));
        ...
        b2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    int response = JOptionPane.showConfirmDialog(null, "Bạn muốn tiếp tục xóa", "Chấp nhận",
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("Library/icons/nineth.png"));
        ...
        JLabel l1 = new JLabel("Thông tin sinh viên");
        l1.setForeground(new Color(102, 205, 170));
        l1.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 26));
        ...
        search.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 17));
        search.setBounds(189, 89, 357, 33);
        contentPane.add(search);
        search.setColumns(10);

        JLabel l2 = new JLabel("Trở về");
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("Library/icons/tenth.png"));
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(95, 158, 160), 3, true), "Sinh viên",
