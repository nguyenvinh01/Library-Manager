...
public class IssueBook extends JFrame implements ActionListener{
    ...
    public IssueBook() {
        ...
        JLabel l4 = new JLabel("NXB");
        l4.setForeground(new Color(47, 79, 79));
        l4.setFont(new Font("Tahoma", Font.BOLD, 14));
        l4.setBounds(47, 165, 100, 23);
        contentPane.add(l4);

        JLabel l5 = new JLabel("Ấn bản");
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Sách",
        ...
        t12.setFont(new Font("Tahoma", Font.BOLD, 14));
        t12.setEditable(false);
        t12.setColumns(10);
        t12.setBounds(508, 185, 208, 20);
        contentPane.add(t12);

        t13 = new JTextField();
        t13.setForeground(new Color(47, 79, 79));
        t13.setFont(new Font("Tahoma", Font.BOLD, 14));
        t13.setEditable(false);
        t13.setColumns(10);
        t13.setBounds(508, 230, 208, 20);
        contentPane.add(t13);

        t14 = new JTextField();
        t14.setForeground(new Color(47, 79, 79));
        t14.setFont(new Font("Tahoma", Font.BOLD, 14));
        t14.setEditable(false);
        t14.setColumns(10);
        t14.setBounds(508, 270, 208, 20);
        contentPane.add(t14);

        JPanel panel_1 = new JPanel();
        panel_1.setBorder(new TitledBorder(new LineBorder(new Color(70, 130, 180), 2, true), "Sinh viên",
                TitledBorder.LEADING, TitledBorder.TOP, null, new Color(100, 149, 237)));
        panel_1.setForeground(new Color(0, 100, 0));
        panel_1.setBounds(360, 38, 378, 300);
